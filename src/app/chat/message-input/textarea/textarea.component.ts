...
export class TextareaComponent implements TextareaInterface, OnChanges, OnDestroy, AfterViewInit {
  ...
  constructor(private emojiInputService: EmojiInputService, private themeService: ThemeService) {
